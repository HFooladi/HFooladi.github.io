...
Implementations of different graph neural networks (GNNs) from scratch for Chemists. You can find the course on my Github: [GNNs-For-Chemists](https://github.com/HFooladi/GNNs-For-Chemists)
